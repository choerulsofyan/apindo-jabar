                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ now()->format('Y-m-d H:i:s') }}" required>
                                @error('tanggal')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="5" required>{{ old('deskripsi', $galeri->deskripsi ?? '') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="imagePreview" src="{{ $imageSrc ?? asset('images/default-image.jpg') }}" alt="Image Preview" style="max-width: 200px;" class="mb-2">
                                <input type="file" class="form-control @error('photo') is-invalid @enderror" id="photo" name="photo" accept=".jpeg,.jpg,.png" {{ isset($galeri) ? '' : 'required' }}>
                                @error('photo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
